...
const ProfilePage = () => {
  ...
  if (loading) {
    return <div className='flex justify-center items-center w-8 h-8 animate-spin'><Loader2  className='w-8 h-8 animate-spin'/></div>
  }
        ...
        <div className='p-6 space-y-6'>
          ...
          <div className='pt-6 border-t border-slate-200'>
            ...
            <div className='space-y-4'>
              ...
              <TextareaField label="Address" name="address" icon={MapPin} value={formData.address} onChange={handleInputChange} placeholder="sector-3, near pacific Mall" />
