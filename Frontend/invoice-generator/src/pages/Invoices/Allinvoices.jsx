...
const Allinvoices = () => {
  ...
  if (loading) {
    return <div className="flex justify-center itw-8 h-8 animate-spin text-blue-600 items-center"> <Loader2 /> </div>
  }

  return (
    <div className="space-y-6">
      <CreateWithAIModel isOpen={isAiModalOpen} onClose={() => setIsAiModalOpen(false)} />
      <ReminderModel isOpen={isReminderModalOpen} onClose={() => setIsReminderModalOpen(false)} invoiceId={selectedInvoiceId} />
                  ...
                  <tr key={invoice._id} className="hover:bg-slate-50" >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <div className="flex items-center justify-end gap-2" onClick={(e) => e.stopPropagation()}>
                        ...
                        {invoice.status !== 'Paid' && (
                          <Button size="small" variant="ghost" onClick={() => handleOpenReminderModel(invoice._id)} title="Generate Reminder" >
