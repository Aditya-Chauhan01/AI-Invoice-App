...
import invoicePic from "../../assets/invoicePic.png"
  ...
  return <section className="relative bg-[#fbfbfb] overflow-hidden">
    ...
    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
        ...
        <div className="mt-12 sm:mt-16 relative max-w-5xl mx-auto">
            <img src={invoicePic} alt="Invoice App Screenshot" className="rounded-2xl shadow-2xl shadow-gray-300 border-4 border-gray-200/20" />
        </div>
    </div>
  </section>
}
