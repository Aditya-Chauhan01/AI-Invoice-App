...
const parseInvoiceFromText = async (req, res) => {
    ...
    try {
        const prompt = `You are an expert invoice data extraction AI. Analyze the following text and extract the relevent information to create an invoice.
...
const generateReminderEmail = async (req, res) => {
    ...
    try {
        ...
        The tone should be friendly but clear. Keep it consise. Start the email with "Subject: ".`;
...
const getDashboardSummary = async (req, res) => {
    try {
        ...
        Based on the following summary of their invoice data, provide 2-3 consice and actionable insights.
